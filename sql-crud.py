...
class Places(base):
    ...
    national_language = Column(String)
...
ahmad_jawed_hazrati = Programmer(
    first_name="Ahmad-Jawed",
    last_name="Hazrati",
    gender="M",
    nationality="Afghan",
    famous_for="Become Software Developer"
)
...
afghanistan = Places(
    ...
    currency="Afghani",
    national_language="Dari and Pashto"
)
...
# session.add(ahmad_jawed_hazrati)
